 ...
 * `param-code:supportsSecondarySidebar` context key in package.json.
 ...
 */
export const CHAT_VIEW_ID_SIDEBAR = 'param-code.chatView.sidebar';
export const CHAT_VIEW_ID_SECONDARY = 'param-code.chatView.secondary';
