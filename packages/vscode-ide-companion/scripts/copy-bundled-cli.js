...
/**
 * Copy the already-built root dist/ folder into the extension dist/param-cli/.
 *
...
const bundledCliDir = path.join(extensionDistDir, 'param-cli');
