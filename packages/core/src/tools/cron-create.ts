    ...
    try {
      ...
      if (recurring) {
        llmContent =
          ...
          'Session-only (not written to disk, dies when param Code exits). ' +
  ...
  constructor(private config: Config) {
    super(
      ...
      'Schedule a prompt to be enqueued at a future time. Use for both recurring schedules and one-shot reminders.\n\n' +
        ...
        '## Session-only\n\n' +
        'Jobs live only in this param Code session — nothing is written to disk, and the job is gone when param Code exits.\n\n' +
        '## Runtime behavior\n\n' +
