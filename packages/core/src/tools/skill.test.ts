  ...
  const mockSkills: SkillConfig[] = [
    {
      ...
      level: 'project',
      filePath: '/project/.param/skills/code-review/SKILL.md',
    ...
    },
    {
      ...
      level: 'user',
      filePath: '/home/user/.param/skills/testing/SKILL.md',
      ...
      const newSkills: SkillConfig[] = [
        {
          ...
          level: 'project',
          filePath: '/project/.param/skills/new-skill/SKILL.md',
      ...
      const newSkills: SkillConfig[] = [
        {
          ...
          level: 'project',
          filePath: '/project/.param/skills/test-skill/SKILL.md',
          body: 'Test content.',
        },
      ];
  ...
  describe('SkillToolInvocation', () => {
    ...
    it('should execute skill load successfully', async () => {
      ...
      expect(llmText).toContain(
        'Base directory for this skill: /project/.param/skills/code-review',
      );
