...
describe('convertGeminiToparamConfig', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });
  ...
  it('should convert basic Gemini config from directory', () => {
    ...
    const result = convertGeminiToparamConfig(mockDir);
  ...
  it('should throw error for missing name', () => {
    ...
    expect(() => convertGeminiToparamConfig(mockDir)).toThrow(
