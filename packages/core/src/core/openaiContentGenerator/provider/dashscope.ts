...
export class DashScopeOpenAICompatibleProvider extends DefaultOpenAICompatibleProvider {
  ...
  static isDashScopeProvider(
    ...
    if (authType === AuthType.PARAM_OAUTH) return true;
  ...
  override buildHeaders(): Record<string, string | undefined> {
    ...
    const userAgent = `paramCode/${version} (${process.platform}; ${process.arch})`;
  ...
  private static readonly VISION_MODEL_PREFIX_PATTERNS = [
    'param-vl', // param-vl-max, param-vl-max-latest, etc.
    'param3-vl-plus', // param3-vl-plus variants
    'param3.5-plus', // param3.5-plus (has built-in vision capabilities)
  ];
