...
A shared React component library for param Code applications, providing cross-platform UI components with consistent styling and behavior.
...
<html>
  <head>
    ...
    <script src="https://unpkg.com/@param-code/webui@0.1.0-beta.2/dist/index.umd.js"></script>

    <!-- Load the CSS -->
    <link
      rel="stylesheet"
      href="https://unpkg.com/@param-code/webui@0.1.0-beta.2/dist/styles.css"
    />
  </head>
  <body>
    <div id="root"></div>
    ...
    <script type="text/babel">
      // Access components from the global paramCodeWebUI object
      const { ChatViewer } = paramCodeWebUI;
...
```tsx
import { Button, Input, Tooltip } from '@param-code/webui';
import { PlatformProvider } from '@param-code/webui/context';
...
```tsx
import { Button } from '@param-code/webui';
...
```tsx
import { Input } from '@param-code/webui';
...
```tsx
import { Tooltip } from '@param-code/webui';
...
```tsx
import { FileIcon, FolderIcon, CheckIcon } from '@param-code/webui/icons';
...
```tsx
import { PlatformProvider, usePlatform } from '@param-code/webui/context';
...
// tailwind.config.js
module.exports = {
  presets: [require('@param-code/webui/tailwind.preset.cjs')],
  // your customizations
};
```
