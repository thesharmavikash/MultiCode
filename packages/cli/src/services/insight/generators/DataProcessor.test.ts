...
import type { Config, ChatRecord } from '@agent-param/param-core';
import type {
  InsightData,
  SessionFacets,
...
vi.mock('@agent-param/param-core', async () => {
  const actual = await vi.importActual<
    typeof import('@agent-param/param-core')
  >('@agent-param/param-core');
  return {
    ...actual,
    read: vi.fn(),
...
import { read as readJsonlFile } from '@agent-param/param-core';
      ...
      const facets: SessionFacets[] = [
        {
          ...
          param_helpfulness: 'very_helpful',
        ...
        },
        {
          ...
          param_helpfulness: 'moderately_helpful',
    ...
    it('should aggregate primary success excluding none', () => {
      const facets: SessionFacets[] = [
        ...
        },
        {
          ...
          user_satisfaction_counts: {},
          param_helpfulness: 'slightly_helpful',
