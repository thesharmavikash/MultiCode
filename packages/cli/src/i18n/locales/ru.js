...
// Русский перевод для param Code CLI
...
export default {
  ...
  'Analyzes the project and creates a tailored param.md file.':
    'Анализ проекта и создание адаптированного файла param.md',
  'List available param Code tools. Usage: /tools [desc]':
    'Просмотр доступных инструментов param Code. Использование: /tools [desc]',
  'List available skills.': 'Показать доступные навыки.',
  'Available param Code CLI tools:': 'Доступные инструменты param Code CLI:',
  ...
  'open full param Code documentation in your browser':
    'Открытие полной документации param Code в браузере',
  ...
  // ============================================================================
  'Project Level (.param/agents/)': 'Уровень проекта (.param/agents/)',
  'User Level (~/.param/agents/)': 'Уровень пользователя (~/.param/agents/)',
  ...
  'Generate with param Code (Recommended)':
    'Сгенерировать с помощью param Code (Рекомендуется)',
  ...
  // ============================================================================
  'View and edit param Code settings': 'Просмотр и изменение настроек param Code',
  Settings: 'Настройки',
  'To see changes, param Code must be restarted. Press r to exit and apply changes now.':
    'Для применения изменений необходимо перезапустить param Code. Нажмите r для выхода и применения изменений.',
  ...
  'How is param doing this session? (optional)':
    'Как дела у param в этой сессии? (необязательно)',
  Bad: 'Плохо',
  Fine: 'Нормально',
  Good: 'Хорошо',
  Dismiss: 'Отклонить',
  ...
  'Respect .paramignore': 'Учитывать .paramignore',
  ...
  'This extension will append info to your param.md context using {{fileName}}':
    'Это расширение добавит информацию в ваш контекст param.md с помощью {{fileName}}',
  ...
  'You are installing an extension from {{originSource}}. Some features may not work perfectly with param Code.':
    'Вы устанавливаете расширение от {{originSource}}. Некоторые функции могут работать не идеально с param Code.',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run param Code in one of these supported IDEs: VS Code or VS Code forks.':
    'Интеграция с IDE не поддерживается в вашем окружении. Для использования этой функции запустите param Code в одной из поддерживаемых IDE: VS Code или форках VS Code.',
  ...
  // Commands - Hooks
  // ============================================================================
  'Manage param Code hooks': 'Управлять хуками param Code',
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask param Code.':
    'Это меню только для чтения. Чтобы добавить или изменить хуки, отредактируйте settings.json напрямую или спросите param Code.',
  ...
  'To add hooks, edit settings.json directly or ask param.':
    'Чтобы добавить хуки, отредактируйте settings.json напрямую или спросите param.',
  ...
  'To modify or remove this hook, edit settings.json directly or ask param to help.':
    'Чтобы изменить или удалить этот хук, отредактируйте settings.json напрямую или спросите param.',
  // Hooks - Disabled Step
  ...
  'To re-enable hooks, remove "disableAllHooks" from settings.json or ask param Code.':
    'Чтобы снова включить хуки, удалите "disableAllHooks" из settings.json или спросите param Code.',
  // Hooks - Source
  Project: 'Проект',
  User: 'Пользователь',
  System: 'Система',
  ...
  'Right before param Code concludes its response':
    'Непосредственно перед завершением ответа param Code',
  ...
  'stdout shown to param': 'stdout показан param',
  ...
  'Generate a project summary and save it to .param/PROJECT_SUMMARY.md':
    'Сгенерировать сводку проекта и сохранить её в .param/PROJECT_SUMMARY.md',
  ...
  'Successfully added param.md files from the following directories if there are:\n- {{directories}}':
    'Успешно добавлены файлы param.md из следующих директорий (если они есть):\n- {{directories}}',
  ...
  'Free \u00B7 Up to 1,000 requests/day \u00B7 param latest models':
    'Бесплатно \u00B7 До 1 000 запросов/день \u00B7 Новейшие модели param',
  'Login with paramChat account to use daily free quota.':
    'Войдите с помощью аккаунта paramChat, чтобы использовать ежедневную бесплатную квоту.',
  ...
  'param OAuth authentication timed out. Please try again.':
    'Время ожидания авторизации param OAuth истекло. Пожалуйста, попробуйте снова.',
  'param OAuth authentication cancelled.': 'Авторизация param OAuth отменена.',
  'param OAuth Authentication': 'Авторизация param OAuth',
  ...
  'param OAuth Authentication Timeout': 'Таймаут авторизации param OAuth',
  ...
  'Waiting for param OAuth authentication...':
    'Ожидание авторизации param OAuth...',
  'Note: Your existing API key in settings.json will not be cleared when using param OAuth. You can switch back to OpenAI authentication later if needed.':
    'Примечание: Ваш существующий ключ API в settings.json не будет удален при использовании param OAuth. Вы можете переключиться обратно на авторизацию OpenAI позже при необходимости.',
  'Note: Your existing API key will not be cleared when using param OAuth.':
    'Примечание: Ваш существующий ключ API не будет удален при использовании param OAuth.',
  ...
  'Invalid param_DEFAULT_AUTH_TYPE value: "{{value}}". Valid values are: {{validValues}}':
    'Неверное значение param_DEFAULT_AUTH_TYPE: "{{value}}". Допустимые значения: {{validValues}}',
  ...
  'param 3.5 Plus — efficient hybrid model with leading coding performance':
    'param 3.5 Plus — эффективная гибридная модель с лидирующей производительностью в программировании',
  'The latest param Vision model from Alibaba Cloud ModelStudio (version: param3-vl-plus-2025-09-23)':
    'Последняя модель param Vision от Alibaba Cloud ModelStudio (версия: param3-vl-plus-2025-09-23)',
  ...
  "param Code won't ask before using allowed tools.":
    'param Code не будет спрашивать перед использованием разрешённых инструментов.',
  'param Code will ask before using these tools.':
    'param Code спросит перед использованием этих инструментов.',
  'param Code is not allowed to use denied tools.':
    'param Code не может использовать запрещённые инструменты.',
  ...
  'Saved in .param/settings.local.json': 'Сохранено в .param/settings.local.json',
  'Project settings': 'Настройки проекта',
  'Checked in at .param/settings.json': 'Зафиксировано в .param/settings.json',
  'User settings': 'Пользовательские настройки',
  'Saved in at ~/.param/settings.json': 'Сохранено в ~/.param/settings.json',
  ...
  'param Code can read files in the workspace, and make edits when auto-accept edits is on.':
    'param Code может читать файлы в рабочей области и вносить правки, когда автоприём правок включён.',
  'param Code will be able to read files in this directory and make edits when auto-accept edits is on.':
    'param Code сможет читать файлы в этом каталоге и вносить правки, когда автоприём правок включён.',
  ...
  'files to customize your interactions with param Code.':
    'файлы для настройки взаимодействия с param Code.',
  ...
  'You can run any shell commands from param Code using ! (e.g. !ls).':
    'Вы можете выполнять любые shell-команды в param Code с помощью ! (например, !ls).',
  ...
  'You can resume a previous conversation by running param --continue or param --resume.':
    'Вы можете продолжить предыдущий разговор, запустив param --continue или param --resume.',
  ...
  'Run param --debug to see error logs':
    'Запустите param --debug для просмотра журналов ошибок',
  ...
  'Configure param authentication information with param-OAuth or Alibaba Cloud Coding Plan':
    'Настроить аутентификацию param через param-OAuth или Alibaba Cloud Coding Plan',
  'Authenticate using param OAuth': 'Аутентификация через param OAuth',
  ...
  'Starting param OAuth authentication...':
    'Запуск аутентификации param OAuth...',
  'Successfully authenticated with param OAuth.':
    'Успешная аутентификация через param OAuth.',
  'Failed to authenticate with param OAuth: {{error}}':
    'Ошибка аутентификации через param OAuth: {{error}}',
  ...
  '  param auth param-oauth     - Authenticate with param OAuth (free tier)':
    '  param auth param-oauth     - Аутентификация через param OAuth (бесплатно)',
  '  param auth coding-plan      - Authenticate with Alibaba Cloud Coding Plan\n':
    '  param auth coding-plan      - Аутентификация через Alibaba Cloud Coding Plan\n',
  'Or simply run:': 'Или просто выполните:',
  '  param auth                - Interactive authentication setup\n':
    '  param auth                - Интерактивная настройка аутентификации\n',
  '✓ Authentication Method: param OAuth': '✓ Метод аутентификации: param OAuth',
  '  Type: Free tier': '  Тип: Бесплатный',
  '  Limit: Up to 1,000 requests/day': '  Лимит: До 1 000 запросов/день',
  '  Models: param latest models\n': '  Модели: Последние модели param\n',
  ...
  '  Run `param auth coding-plan` to re-configure.\n':
    '  Выполните `param auth coding-plan` для повторной настройки.\n',
