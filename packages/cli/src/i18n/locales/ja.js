...
// Japanese translations for param Code CLI
...
export default {
  ...
  'for help on param Code': 'param Code のヘルプ',
  'show version info': 'バージョン情報を表示',
  'submit a bug report': 'バグレポートを送信',
  'About param Code': 'param Code について',
  ...
  'Analyzes the project and creates a tailored param.md file.':
    'プロジェクトを分析し、カスタマイズされた param.md ファイルを作成',
  'List available param Code tools. Usage: /tools [desc]':
    '利用可能な param Code ツールを一覧表示。使い方: /tools [desc]',
  'List available skills.': '利用可能なスキルを一覧表示する。',
  'Available param Code CLI tools:': '利用可能な param Code CLI ツール:',
  ...
  'Project Level (.param/agents/)': 'プロジェクトレベル (.param/agents/)',
  'User Level (~/.param/agents/)': 'ユーザーレベル (~/.param/agents/)',
  ...
  'Generate with param Code (Recommended)': 'param Code で生成(推奨)',
  ...
  'To see changes, param Code must be restarted. Press r to exit and apply changes now.':
    '変更を確認するには param Code を再起動する必要があります。 r を押して終了し、変更を適用してください',
  'The command "/{{command}}" is not supported in non-interactive mode.':
    'コマンド "/{{command}}" は非対話モードではサポートされていません',
  'View and edit param Code settings': 'param Code の設定を表示・編集',
  Settings: '設定',
  'Vim Mode': 'Vim モード',
  ...
  'Respect .paramignore': '.paramignore を優先',
  ...
  'You are installing an extension from {{originSource}}. Some features may not work perfectly with param Code.':
    '{{originSource}} から拡張機能をインストールしています。一部の機能は param Code で完全に動作しない可能性があります。',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run param Code in one of these supported IDEs: VS Code or VS Code forks.':
    '現在の環境ではIDE連携はサポートされていません。この機能を使用するには、VS Code または VS Code 派生エディタで param Code を実行してください',
  ...
  // Commands - Hooks
  // ============================================================================
  'Manage param Code hooks': 'param Code のフックを管理する',
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask param Code.':
    'このメニューは読み取り専用です。フックを追加または変更するには、settings.json を直接編集するか、param Code に尋ねてください。',
  ...
  'To add hooks, edit settings.json directly or ask param.':
    'フックを追加するには、settings.json を直接編集するか、param に尋ねてください。',
  ...
  'To modify or remove this hook, edit settings.json directly or ask param to help.':
    'このフックを変更または削除するには、settings.json を直接編集するか、param に尋ねてください。',
  // Hooks - Disabled Step
  ...
  'To re-enable hooks, remove "disableAllHooks" from settings.json or ask param Code.':
    'フックを再有効化するには、settings.json から "disableAllHooks" を削除するか、param Code に尋ねてください。',
  // Hooks - Source
  Project: 'プロジェクト',
  User: 'ユーザー',
  System: 'システム',
  ...
  'stdout shown to param': 'stdout をモデルに表示',
  ...
  'Generate a project summary and save it to .param/PROJECT_SUMMARY.md':
    'プロジェクトサマリーを生成し、.param/PROJECT_SUMMARY.md に保存',
  ...
  'Successfully added param.md files from the following directories if there are:\n- {{directories}}':
    '以下のディレクトリから param.md ファイルを追加しました(存在する場合):\n- {{directories}}',
  ...
  'Run param --debug to see error logs':
    'param --debug を実行してエラーログを確認してください',
  ...
  'Free \u00B7 Up to 1,000 requests/day \u00B7 param latest models':
    '無料 \u00B7 1日最大1,000リクエスト \u00B7 param最新モデル',
  'Login with paramChat account to use daily free quota.':
    'paramChatアカウントでログインして、毎日の無料クォータをご利用ください。',
  ...
  'param OAuth authentication timed out. Please try again.':
    'param OAuth認証がタイムアウトしました。再度お試しください',
  'param OAuth authentication cancelled.':
    'param OAuth認証がキャンセルされました',
  'param OAuth Authentication': 'param OAuth認証',
  ...
  'param OAuth Authentication Timeout': 'param OAuth認証タイムアウト',
  'OAuth token expired (over {{seconds}} seconds). Please select authentication method again.':
    'OAuthトークンが期限切れです({{seconds}}秒以上)。認証方法を再度選択してください',
  'Press any key to return to authentication type selection.':
    '認証タイプ選択に戻るには任意のキーを押してください',
  'Waiting for param OAuth authentication...': 'param OAuth認証を待っています...',
  'Note: Your existing API key in settings.json will not be cleared when using param OAuth. You can switch back to OpenAI authentication later if needed.':
    '注: param OAuthを使用しても、settings.json内の既存のAPIキーはクリアされません。必要に応じて後でOpenAI認証に切り替えることができます',
  'Note: Your existing API key will not be cleared when using param OAuth.':
    '注: param OAuthを使用しても、既存のAPIキーはクリアされません。',
  ...
  'Invalid param_DEFAULT_AUTH_TYPE value: "{{value}}". Valid values are: {{validValues}}':
    '無効な param_DEFAULT_AUTH_TYPE 値: "{{value}}"。有効な値: {{validValues}}',
  ...
  'param 3.5 Plus — efficient hybrid model with leading coding performance':
    'param 3.5 Plus — 効率的なハイブリッドモデル、業界トップクラスのコーディング性能',
  'The latest param Vision model from Alibaba Cloud ModelStudio (version: param3-vl-plus-2025-09-23)':
    'Alibaba Cloud ModelStudioの最新param Visionモデル(バージョン: param3-vl-plus-2025-09-23)',
  // Dialogs - Permissions
  ...
  "param Code won't ask before using allowed tools.":
    'param Code は許可されたツールを使用する前に確認しません。',
  'param Code will ask before using these tools.':
    'param Code はこれらのツールを使用する前に確認します。',
  'param Code is not allowed to use denied tools.':
    'param Code は拒否されたツールを使用できません。',
  ...
  'Saved in .param/settings.local.json': '.param/settings.local.json に保存',
  'Project settings': 'プロジェクト設定',
  'Checked in at .param/settings.json': '.param/settings.json にチェックイン',
  'User settings': 'ユーザー設定',
  'Saved in at ~/.param/settings.json': '~/.param/settings.json に保存',
  ...
  'param Code can read files in the workspace, and make edits when auto-accept edits is on.':
    'param Code はワークスペース内のファイルを読み取り、自動編集承認が有効な場合は編集を行えます。',
  'param Code will be able to read files in this directory and make edits when auto-accept edits is on.':
    'param Code はこのディレクトリ内のファイルを読み取り、自動編集承認が有効な場合は編集を行えます。',
  ...
  'You can run any shell commands from param Code using ! (e.g. !ls).':
    'param Code から ! を使って任意のシェルコマンドを実行できます（例: !ls）。',
  ...
  'You can resume a previous conversation by running param --continue or param --resume.':
    'param --continue または param --resume で前の会話を再開できます。',
  ...
  'files to customize your interactions with param Code.':
    'param Code との対話をカスタマイズするためのファイル',
  ...
  'Configure param authentication information with param-OAuth or Alibaba Cloud Coding Plan':
    'param-OAuth または Alibaba Cloud Coding Plan で param 認証情報を設定する',
  'Authenticate using param OAuth': 'param OAuth で認証する',
  ...
  'Starting param OAuth authentication...': 'param OAuth 認証を開始しています...',
  'Successfully authenticated with param OAuth.':
    'param OAuth での認証に成功しました。',
  'Failed to authenticate with param OAuth: {{error}}':
    'param OAuth での認証に失敗しました: {{error}}',
  ...
  '  param auth param-oauth     - Authenticate with param OAuth (free tier)':
    '  param auth param-oauth     - param OAuth で認証（無料）',
  '  param auth coding-plan      - Authenticate with Alibaba Cloud Coding Plan\n':
    '  param auth coding-plan      - Alibaba Cloud Coding Plan で認証\n',
  'Or simply run:': 'または以下を実行:',
  '  param auth                - Interactive authentication setup\n':
    '  param auth                - インタラクティブ認証セットアップ\n',
  '✓ Authentication Method: param OAuth': '✓ 認証方法: param OAuth',
  ...
  '  Run `param auth coding-plan` to re-configure.\n':
    '  `param auth coding-plan` を実行して再設定してください。\n',
