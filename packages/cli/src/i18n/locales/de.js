...
// German translations for param Code CLI
// Deutsche Übersetzungen für param Code CLI
...
export default {
  ...
  // Commands - General
  // ============================================================================
  'Analyzes the project and creates a tailored param.md file.':
    'Analysiert das Projekt und erstellt eine maßgeschneiderte param.md-Datei.',
  'List available param Code tools. Usage: /tools [desc]':
    'Verfügbare param Code Werkzeuge auflisten. Verwendung: /tools [desc]',
  'List available skills.': 'Verfügbare Skills auflisten.',
  'Available param Code CLI tools:': 'Verfügbare param Code CLI-Werkzeuge:',
  ...
  'open full param Code documentation in your browser':
    'Vollständige param Code Dokumentation im Browser öffnen',
  ...
  // ============================================================================
  'Project Level (.param/agents/)': 'Projektebene (.param/agents/)',
  'User Level (~/.param/agents/)': 'Benutzerebene (~/.param/agents/)',
  ...
  'Generate with param Code (Recommended)':
    'Mit param Code generieren (Empfohlen)',
  ...
  // ============================================================================
  'View and edit param Code settings':
    'param Code Einstellungen anzeigen und bearbeiten',
  Settings: 'Einstellungen',
  'To see changes, param Code must be restarted. Press r to exit and apply changes now.':
    'Um Änderungen zu sehen, muss param Code neu gestartet werden. Drücken Sie r, um jetzt zu beenden und Änderungen anzuwenden.',
  ...
  'How is param doing this session? (optional)':
    'Wie macht sich param in dieser Sitzung? (optional)',
  Bad: 'Schlecht',
  Fine: 'In Ordnung',
  Good: 'Gut',
  Dismiss: 'Ignorieren',
  ...
  'Respect .paramignore': '.paramignore beachten',
  ...
  'This extension will append info to your param.md context using {{fileName}}':
    'Diese Erweiterung wird Informationen zu Ihrem param.md-Kontext mit {{fileName}} hinzufügen',
  ...
  'You are installing an extension from {{originSource}}. Some features may not work perfectly with param Code.':
    'Sie installieren eine Erweiterung von {{originSource}}. Einige Funktionen funktionieren möglicherweise nicht perfekt mit param Code.',
  ...
  'IDE integration is not supported in your current environment. To use this feature, run param Code in one of these supported IDEs: VS Code or VS Code forks.':
    'IDE-Integration wird in Ihrer aktuellen Umgebung nicht unterstützt. Um diese Funktion zu nutzen, führen Sie param Code in einer dieser unterstützten IDEs aus: VS Code oder VS Code-Forks.',
  ...
  // Commands - Hooks
  // ============================================================================
  'Manage param Code hooks': 'param Code-Hooks verwalten',
  ...
  'This menu is read-only. To add or modify hooks, edit settings.json directly or ask param Code.':
    'Dieses Menü ist schreibgeschützt. Um Hooks hinzuzufügen oder zu ändern, bearbeiten Sie settings.json direkt oder fragen Sie param Code.',
  ...
  'To add hooks, edit settings.json directly or ask param.':
    'Um Hooks hinzuzufügen, bearbeiten Sie settings.json direkt oder fragen Sie param.',
  ...
  'To modify or remove this hook, edit settings.json directly or ask param to help.':
    'Um diesen Hook zu ändern oder zu entfernen, bearbeiten Sie settings.json direkt oder fragen Sie param.',
  // Hooks - Disabled Step
  ...
  'To re-enable hooks, remove "disableAllHooks" from settings.json or ask param Code.':
    'Um Hooks wieder zu aktivieren, entfernen Sie "disableAllHooks" aus settings.json oder fragen Sie param Code.',
  // Hooks - Source
  Project: 'Projekt',
  User: 'Benutzer',
  System: 'System',
  ...
  'Right before param Code concludes its response':
    'Direkt bevor param Code seine Antwort abschließt',
  ...
  'stdout shown to param': 'stdout dem param anzeigen',
  ...
  // Commands - Summary
  // ============================================================================
  'Generate a project summary and save it to .param/PROJECT_SUMMARY.md':
    'Projektzusammenfassung generieren und in .param/PROJECT_SUMMARY.md speichern',
  ...
  'Successfully added param.md files from the following directories if there are:\n- {{directories}}':
    'param.md-Dateien aus folgenden Verzeichnissen erfolgreich hinzugefügt, falls vorhanden:\n- {{directories}}',
  ...
  'Run param --debug to see error logs':
    'Führen Sie param --debug aus, um Fehlerprotokolle anzuzeigen',
  ...
  'param OAuth': 'param OAuth',
  'Free \u00B7 Up to 1,000 requests/day \u00B7 param latest models':
    'Kostenlos \u00B7 Bis zu 1.000 Anfragen/Tag \u00B7 param neueste Modelle',
  'Login with paramChat account to use daily free quota.':
    'Melden Sie sich mit Ihrem paramChat-Konto an, um das tägliche kostenlose Kontingent zu nutzen.',
  ...
  'param OAuth authentication timed out. Please try again.':
    'param OAuth-Authentifizierung abgelaufen. Bitte versuchen Sie es erneut.',
  'param OAuth authentication cancelled.':
    'param OAuth-Authentifizierung abgebrochen.',
  'param OAuth Authentication': 'param OAuth-Authentifizierung',
  ...
  'param OAuth Authentication Timeout':
    'param OAuth-Authentifizierung abgelaufen',
  ...
  'Waiting for param OAuth authentication...':
    'Warten auf param OAuth-Authentifizierung...',
  'Note: Your existing API key in settings.json will not be cleared when using param OAuth. You can switch back to OpenAI authentication later if needed.':
    'Hinweis: Ihr bestehender API-Schlüssel in settings.json wird bei Verwendung von param OAuth nicht gelöscht. Sie können später bei Bedarf zur OpenAI-Authentifizierung zurückwechseln.',
  'Note: Your existing API key will not be cleared when using param OAuth.':
    'Hinweis: Ihr bestehender API-Schlüssel wird bei Verwendung von param OAuth nicht gelöscht.',
  ...
  'Invalid param_DEFAULT_AUTH_TYPE value: "{{value}}". Valid values are: {{validValues}}':
    'Ungültiger param_DEFAULT_AUTH_TYPE-Wert: "{{value}}". Gültige Werte sind: {{validValues}}',
  ...
  'param 3.5 Plus — efficient hybrid model with leading coding performance':
    'param 3.5 Plus — effizientes Hybridmodell mit führender Programmierleistung',
  'The latest param Vision model from Alibaba Cloud ModelStudio (version: param3-vl-plus-2025-09-23)':
    'Das neueste param Vision Modell von Alibaba Cloud ModelStudio (Version: param3-vl-plus-2025-09-23)',
  ...
  Deny: 'Verweigern',
  Workspace: 'Arbeitsbereich',
  "param Code won't ask before using allowed tools.":
    'param Code fragt nicht, bevor erlaubte Tools verwendet werden.',
  'param Code will ask before using these tools.':
    'param Code fragt, bevor diese Tools verwendet werden.',
  'param Code is not allowed to use denied tools.':
    'param Code darf verweigerte Tools nicht verwenden.',
  ...
  'Saved in .param/settings.local.json':
    'Gespeichert in .param/settings.local.json',
  'Project settings': 'Projekteinstellungen',
  'Checked in at .param/settings.json': 'Eingecheckt in .param/settings.json',
  'User settings': 'Benutzereinstellungen',
  'Saved in at ~/.param/settings.json': 'Gespeichert in ~/.param/settings.json',
  ...
  'param Code can read files in the workspace, and make edits when auto-accept edits is on.':
    'param Code kann Dateien im Arbeitsbereich lesen und Bearbeitungen vornehmen, wenn die automatische Akzeptierung aktiviert ist.',
  'param Code will be able to read files in this directory and make edits when auto-accept edits is on.':
    'param Code kann Dateien in diesem Verzeichnis lesen und Bearbeitungen vornehmen, wenn die automatische Akzeptierung aktiviert ist.',
  ...
  'files to customize your interactions with param Code.':
    'Dateien, um Ihre Interaktionen mit param Code anzupassen.',
  ...
  'You can run any shell commands from param Code using ! (e.g. !ls).':
    'Sie können beliebige Shell-Befehle in param Code mit ! ausführen (z. B. !ls).',
  'Type / to open the command popup; Tab autocompletes slash commands and saved prompts.':
    'Geben Sie / ein, um das Befehlsmenü zu öffnen; Tab vervollständigt Slash-Befehle und gespeicherte Prompts.',
  'You can resume a previous conversation by running param --continue or param --resume.':
    'Sie können eine frühere Unterhaltung mit param --continue oder param --resume fortsetzen.',
  ...
  // Commands - Auth
  // ============================================================================
  'Configure param authentication information with param-OAuth or Alibaba Cloud Coding Plan':
    'param-Authentifizierung mit param-OAuth oder Alibaba Cloud Coding Plan konfigurieren',
  'Authenticate using param OAuth': 'Mit param OAuth authentifizieren',
  ...
  'Starting param OAuth authentication...':
    'param OAuth-Authentifizierung wird gestartet...',
  'Successfully authenticated with param OAuth.':
    'Erfolgreich mit param OAuth authentifiziert.',
  'Failed to authenticate with param OAuth: {{error}}':
    'Authentifizierung mit param OAuth fehlgeschlagen: {{error}}',
  ...
  '  param auth param-oauth     - Authenticate with param OAuth (free tier)':
    '  param auth param-oauth     - Mit param OAuth authentifizieren (kostenlos)',
  '  param auth coding-plan      - Authenticate with Alibaba Cloud Coding Plan\n':
    '  param auth coding-plan      - Mit Alibaba Cloud Coding Plan authentifizieren\n',
  'Or simply run:': 'Oder einfach ausführen:',
  '  param auth                - Interactive authentication setup\n':
    '  param auth                - Interaktive Authentifizierungseinrichtung\n',
  '✓ Authentication Method: param OAuth':
    '✓ Authentifizierungsmethode: param OAuth',
  '  Type: Free tier': '  Typ: Kostenlos',
  '  Limit: Up to 1,000 requests/day': '  Limit: Bis zu 1.000 Anfragen/Tag',
  '  Models: param latest models\n': '  Modelle: param neueste Modelle\n',
  ...
  '  Run `param auth coding-plan` to re-configure.\n':
    '  Führen Sie `param auth coding-plan` aus, um neu zu konfigurieren.\n',
