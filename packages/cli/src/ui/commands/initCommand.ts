...
import { getCurrentGeminiMdFilename } from '@agent-param/param-core';
...
export const initCommand: SlashCommand = {
  name: 'init',
  get description() {
    return t('Analyzes the project and creates a tailored param.md file.');
  },
  ...
  action: async (
    ...
    return {
      type: 'submit_prompt',
      content: `
You are param Code, an interactive CLI agent. Analyze the current directory and generate a comprehensive ${contextFileName} file to be used as instructional context for future interactions.
