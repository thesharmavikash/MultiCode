...
const CACHED_PARAM_OAUTH_MODELS: AvailableModel[] = PARAM_OAUTH_MODELS.map(
  (model) => ({
    id: model.id,
...
function getparamOAuthModels(): readonly AvailableModel[] {
  return CACHED_PARAM_OAUTH_MODELS;
}
