...
describe('HookConfigDetailStep', () => {
  const createMockHookEvent = (): HookEventDisplayInfo => ({
    ...
    shortDescription: 'Right before param Code concludes its response',
    description: '',
    exitCodes: [
  ...
  it('should render source for Extensions with path', () => {
    ...
    const hookConfig = createMockHookConfig(
      ...
      'ralph-wiggum',
      '/Users/test/.param/extensions/ralph-wiggum',
    );
    ...
    expect(lastFrame()).toContain('/Users/test/.param/extensions/ralph-wiggum');
  });
