...
import { ApprovalMode } from '@agent-param/param-core';
...
describe('InputPrompt', () => {
  ...
  describe('clipboard image paste', () => {
    ...
    describeConditional(
      ...
      async () => {
        ...
        vi.mocked(clipboardUtils.saveClipboardImage).mockResolvedValue(
          '/Users/mochi/.param/tmp/clipboard-123.png',
        );
    ...
    it('should handle Cmd+V when clipboard has an image', async () => {
      vi.mocked(clipboardUtils.clipboardHasImage).mockResolvedValue(true);
      vi.mocked(clipboardUtils.saveClipboardImage).mockResolvedValue(
        '/Users/mochi/.param/tmp/clipboard-456.png',
      );
    ...
    it('should insert image path at cursor position with proper spacing', async () => {
      const imagePath = '/Users/mochi/.param/tmp/clipboard-456.png';
      vi.mocked(clipboardUtils.clipboardHasImage).mockResolvedValue(true);
