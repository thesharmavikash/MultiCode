...
import { OutputFormat } from '@agent-param/param-core';
...
describe('gemini.tsx main function', () => {
  ...
  beforeEach(() => {
    ...
    originalEnvGeminiSandbox = process.env['param_SANDBOX'];
    originalEnvSandbox = process.env['SANDBOX'];
    delete process.env['param_SANDBOX'];
  ...
  afterEach(() => {
    ...
    if (originalEnvGeminiSandbox !== undefined) {
      process.env['param_SANDBOX'] = originalEnvGeminiSandbox;
    } else {
      delete process.env['param_SANDBOX'];
    }
...
describe('gemini.tsx main function kitty protocol', () => {
  ...
  beforeEach(() => {
    ...
    originalEnvNoRelaunch = process.env['param_CODE_NO_RELAUNCH'];
    process.env['param_CODE_NO_RELAUNCH'] = 'true';
  ...
  afterEach(() => {
    ...
    if (originalEnvNoRelaunch !== undefined) {
      process.env['param_CODE_NO_RELAUNCH'] = originalEnvNoRelaunch;
    } else {
      delete process.env['param_CODE_NO_RELAUNCH'];
    }
  });
