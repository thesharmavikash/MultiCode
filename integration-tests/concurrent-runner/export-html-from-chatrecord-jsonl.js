...
<head>
  ...
  <title>param Code Chat Export</title>
  ...
  <script src="https://unpkg.com/@param-code/webui@0.1.0-beta.4/dist/index.umd.js"></script>

  <!-- Load the CSS -->
  <link rel="stylesheet" href="https://unpkg.com/@param-code/webui@0.1.0-beta.4/dist/styles.css">
...
<body>
  <div class="page-wrapper">
    <div class="header">
      <div class="header-left">
        ...
        <div class="logo">
          <div class="logo-text" data-text="param">
            <span class="logo-text-inner">param</span>
          </div>
        </div>
      </div>
      <div class="meta">
  ...
  <script>
    ...
    const { ChatViewer, PlatformProvider } = paramCodeWebUI;
