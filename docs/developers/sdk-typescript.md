...
- Node.js >= 20.0.0
- [param Code](https://github.com/paramLM/param-code) >= 0.4.0 (stable) installed and accessible in PATH

> **Note for nvm users**: If you use nvm to manage Node.js versions, the SDK may not be able to auto-detect the param Code executable. You should explicitly set the `pathToparamExecutable` option to the full path of the `param` binary.
