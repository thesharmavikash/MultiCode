...
| Building Open Capabilities      | ✅ Custom Commands                                                                                                                                                                 | ✅ paramCode SDK<br>✅ Extension System                                                                                                                                                  |
...
| Github Actions          | `V0.5.0`  | param-code-action and automation                         | Integrating Community Ecosystem | 1     |
| VSCode Plugin           | `V0.5.0`  | VSCode extension plugin                                 | Integrating Community Ecosystem | 1     |
| paramCode SDK            | `V0.4.0`  | Open SDK for third-party integration                    | Building Open Capabilities      | 1     |
...
| Tool: TextSearch        | `V0.0.8+` | Text search tool (grep, supports .paramignore)           | Coding Workflow                 | 1     |
...
| OAuth                   | `V0.0.5+` | OAuth login authentication (param OAuth)                 | User Experience                 | 1     |
