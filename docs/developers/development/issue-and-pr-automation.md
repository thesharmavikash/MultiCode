...
- **Workflow File**: `.github/workflows/param-automated-issue-triage.yml`
- **When it runs**: Immediately after an issue is created or reopened.
- **What it does**:
  - It uses a param model to analyze the issue's title and body against a detailed set of guidelines.
...
- **Workflow File**: `.github/workflows/param-scheduled-pr-triage.yml`
...
- **Workflow File**: `.github/workflows/param-scheduled-issue-triage.yml`
- **When it runs**: Every hour on all open issues.
- **What it does**:
  - It actively seeks out issues that either have no labels at all or still have the `status/need-triage` label.
  - It then triggers the same powerful paramCode-based analysis as the initial triage bot to apply the correct labels.
- **What you should do**:
...
This workflow handles the process of packaging and publishing new versions of param Code.
